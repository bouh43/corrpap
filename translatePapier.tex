...
C'est pourquoi la durée des trajectoires générés par les fonctions à base radiale est fixe et égale à $\bar{s}$. 
...
\toimprove{Ce terme $\alpha$ change la phase des fonctions à base radiale, foncitions qui sont étalée temporellement sur l'ensemble de la durée de la trajectoire}.
...
\end{eqnarray}
où $\Phi_{\alpha t}$ est la matrice de fonctions à base radiale évaluée au temps $\alpha t$. L'ensemble des $M$ fonctions Gaussiennes représentant les fonctions à base radialesont étalée pour représenter le même nombre d'échantillons $\bar{s}$. Ainsi, on obtient :
